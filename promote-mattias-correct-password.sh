...
# Promote User to Super Admin Script (Development) - Correct Password
# This script promotes mattiasgebrie@gmail.com to SUPER_ADMIN role

echo "👑 Promote User to Super Admin (Development) - Correct Password"
echo "============================================================="
