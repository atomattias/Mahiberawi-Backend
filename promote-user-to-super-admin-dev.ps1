...
Write-Host "=== User Promotion to Super Admin (DEV) ===" -ForegroundColor Green
Write-Host "This script promotes any user to SUPER_ADMIN role in DEVELOPMENT" -ForegroundColor Yellow
Write-Host "=========================================" -ForegroundColor Green

# Development environment URL (update this with your dev Railway URL)
$baseUrl = "https://mahiberawi-backend-dev.up.railway.app/api"
...
Write-Host "`n=== Promotion Process Complete (DEV) ===" -ForegroundColor Green
