    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .requestMatchers("/auth/register", "/auth/login", "/auth/verify-email", "/auth/verify-phone", 
                           ...
                           "/auth/phone/debug-codes", "/auth/phone/debug-twilio-config", "/auth/phone/debug-env-vars", "/auth/phone/debug-twilio-test", "/auth/phone/resend-verification", "/auth/phone/registration-status/**",
