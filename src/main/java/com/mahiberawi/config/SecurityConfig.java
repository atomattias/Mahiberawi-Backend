...
import com.mahiberawi.security.JwtAuthenticationFilter;
import com.mahiberawi.security.JwtService;
import com.mahiberawi.service.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .requestMatchers("/auth/register", "/auth/login", "/auth/verify-email", "/auth/verify-phone", 
                           ...
                           "/auth/phone/debug-codes", "/auth/phone/debug-twilio-config", "/auth/phone/debug-env-vars", "/auth/phone/debug-twilio-test", "/auth/phone/debug-twilio-send", "/auth/phone/debug-sms-factory", "/auth/phone/debug-sms-send-direct", "/auth/phone/resend-verification", "/auth/phone/registration-status/**",
