# Generic User Promotion to Super Admin Script (Staging Environment)
# This script promotes any user to Super Admin role in STAGING environment

Write-Host "=== User Promotion to Super Admin (STAGING) ===" -ForegroundColor Green
Write-Host "This script promotes any user to SUPER_ADMIN role in STAGING" -ForegroundColor Yellow
Write-Host "=========================================" -ForegroundColor Green

# Staging environment URL (update this with your staging Railway URL)
$baseUrl = "https://mahiberawi-backend-staging.up.railway.app/api"
...
Write-Host "`n=== Promotion Process Complete (STAGING) ===" -ForegroundColor Green
